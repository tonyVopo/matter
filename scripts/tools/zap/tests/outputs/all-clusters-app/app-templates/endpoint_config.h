...
#define GENERATED_ATTRIBUTE_COUNT 1021
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(19), 0x00000004, 8, ZAP_TYPE(BITMAP64),                                                          \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(27), 0x00000009, 5, ZAP_TYPE(INT40U),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int40u */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(32), 0x0000000A, 6, ZAP_TYPE(INT48U),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int48u */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(38), 0x0000000B, 7, ZAP_TYPE(INT56U),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int56u */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(45), 0x0000000C, 8, ZAP_TYPE(INT64U),                                                            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(53), 0x00000011, 5, ZAP_TYPE(INT40S),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int40s */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(58), 0x00000012, 6, ZAP_TYPE(INT48S),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int48s */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(64), 0x00000013, 7, ZAP_TYPE(INT56S),                                                            \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) }, /* int56s */                                              \
        { ZAP_LONG_DEFAULTS_INDEX(71), 0x00000014, 8, ZAP_TYPE(INT64S),                                                            \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(95), 0x00004004, 8, ZAP_TYPE(BITMAP64),                                                          \
        ...
        { ZAP_LONG_DEFAULTS_INDEX(155), 0x00004018, 8, ZAP_TYPE(DOUBLE),                                                           \
          ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(READABLE) |                                                            \
...
#define GENERATED_COMMANDS { \
  ...
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=236)*/ \
  ...
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=274)*/ \
  ...
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=310)*/ \
  ...
  0x00000008 /* ReorderNetwork */, \
  chip::kInvalidCommandId /* end of list */, \
  /*   GeneratedCommandList (index=368)*/ \
  0x00000001 /* ScanNetworksResponse */, \
  0x00000005 /* NetworkConfigResponse */, \
  0x00000007 /* ConnectNetworkResponse */, \
  chip::kInvalidCommandId /* end of list */, \
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 236 ), \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  { \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(697), \
      .attributeCount = 7, \
      .clusterSize = 7, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(727), \
      .attributeCount = 5, \
      .clusterSize = 3, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(771), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(797), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(810), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(823), \
      .attributeCount = 13, \
      .clusterSize = 2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(862), \
      .attributeCount = 3, \
      .clusterSize = 19, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(865), \
      .attributeCount = 2, \
      .clusterSize = 6, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .attributes = ZAP_ATTRIBUTE_INDEX(867), \
      .attributeCount = 5, \
      .clusterSize = 6, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 274 ), \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 281 ), \
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 285 ), \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  { \
      ...
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 310 ), \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION), \
      .functions = chipFuncArrayGroupsServer, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 325 ), \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER) | ZAP_CLUSTER_MASK(INIT_FUNCTION) | ZAP_CLUSTER_MASK(SHUTDOWN_FUNCTION), \
      .functions = chipFuncArrayOnOffServer, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 337 ), \
      .generatedCommandList = nullptr, \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
  { \
      /* Endpoint: 2, Cluster: Descriptor (server) */ \
      .clusterId = 0x0000001D, \
      .attributes = ZAP_ATTRIBUTE_INDEX(980), \
      .attributeCount = 7, \
      .clusterSize = 0, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      /* Endpoint: 2, Cluster: Power Source (server) */ \
      .clusterId = 0x0000002F, \
      .attributes = ZAP_ATTRIBUTE_INDEX(987), \
      .attributeCount = 9, \
      .clusterSize = 70, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 344 ), \
  ...
  { \
      ...
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 361 ), \
      .generatedCommandList = ZAP_GENERATED_COMMANDS_INDEX( 368 ), \
      .eventList = nullptr, \
      .eventCount = 0, \
    },\
}
...
#define ATTRIBUTE_MAX_SIZE (3642)
